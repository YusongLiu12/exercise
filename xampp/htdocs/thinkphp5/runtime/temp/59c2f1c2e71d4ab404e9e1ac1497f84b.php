<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"D:\xampp\htdocs\thinkphp5\public/../application/index\view\klass\index.html";i:1689684114;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
        ...
        <div class="col-md-12">
            ...
            <table class="table table-hover table-bordered">
                ...
                <tr>
                    ...
                    <td><?php echo $klass->Teacher->name; ?></td>
                    <td>
                        <a class="btn btn-danger btn-sm" href="<?php echo url('delete?id=' . $klass->getData('id')); ?>"><i class="glyphicon glyphicon-trash"></i>&nbsp;删除</a>&nbsp;
                        <a class="btn btn-sm btn-primary" href="<?php echo url('edit?id=' . $klass->getData('id')); ?>"><i class="glyphicon glyphicon-pencil"></i>&nbsp;编辑</a>
                    </td>
                </tr>
